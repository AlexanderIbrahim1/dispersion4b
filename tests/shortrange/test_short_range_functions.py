...
class TestExponentialDecayOrder2:
    def test_basic_functionality(self, edo2_args):
        edo2 = ExponentialDecayOrder2(edo2_args.coeff, edo2_args.expon_lin, edo2_args.expon_sq)
    ...
    def test_all_expon_lin_allowed(self, expon_lin, edo2_args):
        with nullcontext():
            assert ExponentialDecayOrder2(edo2_args.coeff, expon_lin, edo2_args.expon_sq) is not None
