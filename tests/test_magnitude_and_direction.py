...
from dispersion4b.potential import MagnitudeAndDirection
from dispersion4b.potential import _distance_and_unit_vector


def test_unit_vector():
    p0 = Cartesian3D(0.0, 0.0, 0.0)
    p1 = Cartesian3D(1.0, 0.0, 0.0)
    mad = _distance_and_unit_vector(p0, p1)
